...
scores$Method[scores$Method == "CONSULT-II 5Gb (0.00)"] <- "CONSULT-II 5Gb ~ 268Mx2 k-mers"
scores$Method[scores$Method == "CONSULT-II 3Gb (0.00)"] <- "CONSULT-II 3Gb ~ 150Mx2 k-mers"
scores$Method[scores$Method == "k=28 w=31 h=12 b=16 l=2 mixed const. ~ 3.2Gb 268M×2 k-mers (0.00)"]<- "KRANK 3.2Gb ~ 268M×2 k-mers"

ggplot(
  scores %>% filter(
    Method %in% c(
      "CONSULT-II 5Gb ~ 268Mx2 k-mers",
      "CONSULT-II 3Gb ~ 150Mx2 k-mers",
      "KRANK 3.2Gb ~ 268M×2 k-mers"
    )
  ) %>% 
    mutate(
